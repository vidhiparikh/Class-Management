...
updated_at = ?, updated_by = ? WHERE id = ?";
    ...
    public function populateSemestersWithSelected($sem_id){
//        $result=$this->readAllRecordsWithCondition($this->tableName,"and id=$id");
//        $options="";
//        while($row = mysqli_fetch_assoc($result)){
//            extract($row);
//            $options .= "<option value= '$id'>$sem</option>";
...
//        echo $options;
        ...
        while($row = mysqli_fetch_assoc($result)){
            extract($row);
            //$options .= "<option value= '$id'".if $sem_id==$id {echo 'selected';}.">$sem</option>";
        }
        echo $options;
