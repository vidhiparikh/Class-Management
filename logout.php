...
<!-- Begin page -->
<div class="accountbg" style="background: url('assets/images/backgound.jpg');background-size: cover;">
            ...
            <div class="account-box">
                ...
                <div class="card-box p-5">
                    ...
                    <div class="text-center m-b-20">
                        ...
                        <h4>See You Again !</h4>
                        <p class="text-muted font-14 m-t-10"> You are now successfully sign out. Back to <a href="new_login.php" class="text-dark m-r-5"><b>Sign In</b></a></p>
                    </div>
